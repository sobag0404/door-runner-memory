...
- Android 13 themed icon support uses `drawable/ic_launcher_monochrome.xml`, a single-color vector generated from the same original road/door/runner placeholder composition.
...
- Android 13 themed icon monochrome artwork is present and checked on an Android 13+ launcher before release.
...
- Monochrome themed icon source: deterministic vector generated by the same local script from simple original road, door, and runner shapes.
...
- API 35 themed icon validation path and screenshot blocker notes are recorded in `docs/android-themed-icon-evidence-v0.3.md`.
