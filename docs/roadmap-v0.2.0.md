...
Current post-v0.1 hardening baseline: release-readiness PRs through the final docs cleanup are merged before tagging. The latest verified release-candidate CI run passed on Ubuntu and Windows with dependency audit, build/type-check, lint, unit tests, e2e/smoke, and focused a11y smoke: https://github.com/sobag0404/door-runner-memory/actions/runs/27505679971. The draft v0.2 release-readiness snapshot lives in `docs/release-status-v0.2.0.md`; draft notes live in `docs/release-notes-v0.2.0.md`.
