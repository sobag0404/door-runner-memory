...
- PR #2 through PR #11 are merged into `main`.
- Current `main`: `38ec84071e0a504328418a0711d0cb8cac1bc284`.
- Post-merge `main` CI is green: https://github.com/sobag0404/door-runner-memory/actions/runs/27501163941
...
- Visual direction is documented in `docs/visual-direction.md`; PR #11 added the first scoped original runner-scene visual polish prototype without copying characters, logos, exact UI, proprietary assets, or recognizable level art.
- Do not claim gameplay rules, scoring, daily sequence, or persisted localStorage schema/key changes from PR #2 through PR #11.
